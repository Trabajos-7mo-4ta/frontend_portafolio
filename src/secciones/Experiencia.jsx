...
export default function Experiencia() {
  ...
  const fetchExperiencias = async () => {
    try {
      const res = await fetch("https://backend-portafolio-rlqp.onrender.com/experiencia");
    ...
    try {
      if (editingExp) {
        const res = await fetch(
          `https://backend-portafolio-rlqp.onrender.com/experiencia/${editingExp.id}`,
          {
            method: "PUT",
  ...
  const handleConfirmarEliminar = async () => {
    try {
      const res = await fetch(
        `https://backend-portafolio-rlqp.onrender.com/experiencia/${idAEliminar}`,
        {
          method: "DELETE",
        }
      );
